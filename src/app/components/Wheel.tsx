...
export default function Wheel({
  ...
  labels: string[];      // segments visibles
  highlight?: string;    // nom à faire "tomber" sous l'aiguille
  onSpinEnd?: () => void;
}) {
  ...
  // Calcule l'index cible (si highlight présent)
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => {
      ...
      setAngle(-targetDeg); // sens horaire (inverse)
    });
